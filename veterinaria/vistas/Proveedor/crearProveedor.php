<?php
    ...
    if(isset($_POST['registrar'])){
        ...
        $r=$controlador->crear($_POST['nombre_farmaceutica'],$_POST['direccion_farmaceutica'],$_POST['telefono_farmaceutica'],$_POST['correo_farmaceutica']);
...
<section>
    ...
    <div>
        ...
        <tr class="espacio">
            <td aling="right"> <label for="correo_farmaceutica">Correo de la farmaceutica:</label></td><td><input type="text" class="form-control" name="correo_farmaceutica" id="correo_farmaceutica" placeholder="Ingresa el correo" autofocus required></td>
