...
<section>
    ...
    <div>
        ...
        <tr class="espacio">
        <td aling="right"> <label for="diagnostico">Diagnostico:</label></td><td><input type="text" class="form-control" name="diagnostico" id="diagnostico" placeholder="Ingresa el diagnostico" pattern="[a-zA-Z0-9,\u00C0-\u017F ]{2,254}" oninvalid="this.setCustomValidity('Rellena este campo')" oninput="this.setCustomValidity('')" autofocus required></td>

        </tr>

        <tr class="espacio">
            <td aling="right"> <label for="nombre_mascota">Nombre de Mascota:</label></td><td><input type="text" class="form-control" name="nombre_mascota" id="nombre_mascota" placeholder="Ingresa el nombre"  pattern="[a-zA-Z0-9\u00C0-\u017F ]{2,254}" oninvalid="this.setCustomValidity('Rellena este campo pofa')" oninput="this.setCustomValidity('')" autofocus required></td>

        </tr>

        <tr class="espacio">
            <td aling="right"> <label for="tratamiento">Tratamiento:</label></td><td><input type="text" class="form-control" name="tratamiento" id="tratamiento" placeholder="Ingresa el tratamiento" pattern="[a-zA-Z0-9,\u00C0-\u017F ]{2,254}" oninvalid="this.setCustomValidity('Rellena este campo')" oninput="this.setCustomValidity('')" autofocus required></td>

        </tr>

        <tr class="espacio">
            <td aling="right"> <label for="nombre_vacuna">Nombre de la vacuna:</label></td><td><input type="text" class="form-control" name="nombre_vacuna" id="nombre_vacuna" placeholder="Ingresa el nombre" pattern="[a-zA-Z0-9,\u00C0-\u017F ]{2,254}" oninvalid="this.setCustomValidity('Rellena este campo')" oninput="this.setCustomValidity('')" autofocus required></td>
