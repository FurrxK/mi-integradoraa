...
<section>
    <div class="container">
        ...
        <tr class="espacio">
            <td aling="right"> <label for="nombre">Nombre de la vacuna:</label></td><td><input type="text" class="form-control" name="nombre" id="nombre" Value="<?php echo $row['nombre']; ?>" pattern="[a-zA-Z0-9'\u00C0-\u017F ]{2,254}" oninvalid="this.setCustomValidity('Rellene el campo con una vacuna valida')" oninput="this.setCustomValidity('')" ></td>
        ...
        <tr class="espacio">
            <td aling="right"> <label for="cantidad">Cantidad:</label></td><td><input type="number" class="form-control" name="cantidad" id="cantidad" Value="<?php echo $row['cantidad']; ?>" placeholder="Ingresa la cantidad" pattern="[0-9\u00C0-\u017F ]{2,254}" oninvalid="this.setCustomValidity('No se aceptan letras')" oninput="this.setCustomValidity('')"></td>

        </tr>

        <tr class="espacio">
            <td aling="right"> <label for="tipo_vacuna">Tipo de vacuna:</label></td><td><input type="text" class="form-control" name="tipo_vacuna" id="tipo_vacuna" Value="<?php echo $row['tipo_vacuna']; ?>" placeholder="Ingresa el tipo" pattern="[a-zA-Z\u00C0-\u017F ]{2,254}" oninvalid="this.setCustomValidity('No se aceptan números')" oninput="this.setCustomValidity('')"></td>
