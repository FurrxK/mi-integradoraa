...
<section>
    ...
    <div>
        ...
        <tr class="espacio">
        <td aling="right"> <label for="nombre">Nombe de la vacuna:</label></td><td><input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingresa la vacuna" pattern="[a-zA-Z0-9'\u00C0-\u017F ]{2,254}" oninvalid="this.setCustomValidity('Rellene el campo con una vacuna valida')" oninput="this.setCustomValidity('')" autofocus required></td>

        </tr>

        <tr class="espacio">
            <td aling="right"> <label for="fecha_expiracion">Fecha de expiracion:</label></td><td><input type="date" class="form-control" name="fecha_expiracion" id="fecha_expiracion" placholder="Ingresa la fecha de expiración"  autofocus required></td>
        ...
        <tr class="espacio">
            <td aling="right"> <label for="fecha_elaboracion">Fecha de elaboración:</label></td><td><input type="date" class="form-control" name="fecha_elaboracion" id="fecha_elaboracion" placeholder="Ingresa la fecha de elaboración" autofocus required></td>
        ...
        <tr class="espacio">
            <td aling="right"> <label for="tipo_vacuna">Tipo de vacuna:</label></td><td><input type="text" class="form-control" name="tipo_vacuna" id="tipo_vacuna" placeholder="Ingresa el tipo" pattern="[a-zA-Z\u00C0-\u017F ]{1,254}" oninvalid="this.setCustomValidity('No se aceptan números')" oninput="this.setCustomValidity('')" autofocus required></td>
